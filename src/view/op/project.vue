<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="实现语言1php2go3java4js" prop="lang" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.lang,PROJECT_LANGOptions) }}
            </template>
        </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="实现语言1php2go3java4js:"  prop="lang" >
          <el-select v-model="formData.lang" placeholder="请选择" style="width:100%" :clearable="true" >
...
// 全量引入格式化工具 请按需保留
import { getDictFunc, formatDate, formatBoolean, formatUnixDate,filterDict } from '@/utils/format'
